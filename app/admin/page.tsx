...
export default function AdminDashboard() {
  ...
  return (
    <SidebarProvider>
      <Sidebar className="bg-[#1F2E4F] shadow-2xl border-r-2 border-[#27272A]">
        <SidebarHeader className="p-4 bg-[#000000] border-b-2 border-[#27272A]">
          <div className="text-2xl font-extrabold tracking-tight text-[#FAFAFA]">
            <span style={{ color: '#009FCC' }}>IA</span><span style={{ color: '#025066' }}> Labs</span>
          </div>
        </SidebarHeader>
        ...
        <SidebarFooter className="p-4 bg-[#000000] border-t-2 border-[#27272A]">
          <SidebarMenu>
            <SidebarMenuItem>
      ...
      <SidebarInset className="bg-[#1F2E4F] min-h-screen">
        {/* Header for mobile and content area */}
        <header className="flex h-16 shrink-0 items-center gap-2 bg-[#000000] px-4 shadow-lg border-b-2 border-[#27272A]">
        ...
        <div className="p-6 bg-[#1F2E4F] min-h-[calc(100vh-4rem)]">
            ...
            <TabsContent value="overview" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {dashboardStats.map((stat, index) => (
                  <Card key={index} className="bg-[#27272A] shadow-lg rounded-xl border border-[#009FCC]">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-semibold text-[#009FCC] uppercase tracking-wide">{stat.title}</CardTitle>
                      <stat.icon className={`h-4 w-4 ${stat.color}`} />
                    </CardHeader>
                    <CardContent>
                      <div className="text-2xl font-extrabold text-[#FAFAFA]">{stat.value}</div>
