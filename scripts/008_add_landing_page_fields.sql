...
ADD COLUMN IF NOT EXISTS footer_text TEXT DEFAULT '© 2025 IA Code Labs. Todos os direitos reservados.',
...
SET
  ...
  footer_text = COALESCE(footer_text, '© 2025 IA Code Labs. Todos os direitos reservados.'),
